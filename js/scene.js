...
export default class MainScene extends Phaser.Scene {
    ...
    create() {
        this.paddleL = this.add.existing(new Paddle(this, this.paddleOffsetX, this.game.config.height * 0.5, "paddle", {"up": 65, "down": 90}));
        ...
        this.ball = this.add.existing(new Ball(this, 0, 0, "ball", this.paddleL, this.paddleR));
